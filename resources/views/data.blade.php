...
{{--                                    </div>--}}
{{--                                </div>--}}
                            <form method="GET" action="{{ route('data.index') }}" x-data="{ open: false }" @click.away="open = false" class="relative inline-block">
                                <!-- Dropdown Button -->
                            ...
                            <tr>
                                ...
                                <td class="h-px w-52 whitespace-nowrap">
                                    <div class="px-6 py-3">
                                        ...
                                        @foreach($personalDetail->Program as $programs)
                                            <span class="block text-sm font-normal text-gray-500">{{ ucfirst($programs->name)}}</span>
                                        @endforeach
                                    </div>
                                </td>
