    ...
    <div class="max-w-4xl px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        ...
        <div class="bg-white rounded-xl shadow p-4 sm:p-7">
            <div class="mt-10 sm:mt-0 pb-2">
                <form action="<?php echo e(route('import')); ?>" method="POST" enctype="multipart/form-data" class="flex items-center justify-between bg-white p-4 rounded-lg drop-shadow-lg">
                    <?php echo csrf_field(); ?>
            ...
            <?php endif; ?>
            <form action="<?php echo e(route('personal_information.store')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <!-- Section -->
                <div class="grid sm:grid-cols-12 gap-2 sm:gap-4 py-8 first:pt-0 last:pb-0 border-t first:border-transparent border-gray-200">
                    ...
                    <div class="sm:col-span-9">
                        <select id="prison" x-model="prison" name="prison_id" class="py-2 px-3 pe-11 block w-80 border-gray-200 shadow-sm text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none" required>
                            ...
                            <?php $__currentLoopData = get_prisons(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prison): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($prison->id); ?>"><?php echo e(ucfirst($prison->name)); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div class="sm:col-span-3">
                    ...
                    <div class="sm:col-span-9">
                        <input
                            ...
                            name="end_sentence"
                            type="date"
                            min="<?php echo e(\Carbon\Carbon::today()->toDateString()); ?>" class="py-2 px-3 pe-11 block w-full border-gray-200 shadow-sm rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none">
                    </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\theek\Herd\charity\resources\views/dashboard.blade.php ENDPATH**/ ?>